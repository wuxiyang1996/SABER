#!/usr/bin/env bash
# Evaluate InternVLA-M1 on LIBERO using pre-recorded action-inflation attack prompts from openpi_pi0.
#
...
#
# Usage:
#   bash run_eval_internvla_m1_from_pi0_action_inflation.sh                 # GPU 0
#   bash run_eval_internvla_m1_from_pi0_action_inflation.sh --gpu 2         # GPU 2
#   bash run_eval_internvla_m1_from_pi0_action_inflation.sh --no-aggregate  # skip aggregation
set -euo pipefail
...
echo "========================================"
echo "  InternVLA-M1 Action Inflation Replay Attack Evaluation"
echo "  Victim:  ${VICTIM}"
...
echo ""
echo "========================================"
echo "  InternVLA-M1 action inflation evaluation complete."
