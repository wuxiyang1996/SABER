#!/usr/bin/env bash
# Evaluate MiniVLA (Stanford-ILIAD/minivla-libero90-prismatic) on LIBERO
# using pre-recorded attack prompts from openpi_pi05.
#
# MiniVLA specifics:
...
#
# Usage:
#   bash run_eval_minivla_from_pi05.sh                 # GPU 0
#   bash run_eval_minivla_from_pi05.sh --gpu 2        # GPU 2
#   bash run_eval_minivla_from_pi05.sh --no-aggregate # skip aggregation
set -euo pipefail
...
echo "========================================"
echo "  MiniVLA Replay Attack Evaluation"
...
echo ""
echo "========================================"
echo "  MiniVLA evaluation complete."
