#!/usr/bin/env bash
# Evaluate OpenVLA-OFT on LIBERO using pre-recorded attack prompts from openpi_pi05.
#
...
# OpenVLA-OFT twice per episode (baseline + attack).
#
...
#
# Usage:
#   bash run_eval_openvla_oft_from_pi05.sh                 # GPU 3
#   bash run_eval_openvla_oft_from_pi05.sh --gpu 1         # GPU 1
#   bash run_eval_openvla_oft_from_pi05.sh --no-aggregate  # skip aggregation
set -euo pipefail
...
echo "========================================"
echo "  OpenVLA-OFT Replay Attack Evaluation"
echo "  Victim:  ${VICTIM}"
...
echo ""
echo "========================================"
echo "  OpenVLA-OFT evaluation complete."
