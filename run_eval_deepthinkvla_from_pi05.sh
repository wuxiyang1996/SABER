#!/usr/bin/env bash
# Evaluate DeepThinkVLA on LIBERO using pre-recorded attack prompts from openpi_pi05.
#
...
# DeepThinkVLA twice per episode (baseline + attack).
#
...
#
# Usage:
#   bash run_eval_deepthinkvla_from_pi05.sh                 # GPU 0
#   bash run_eval_deepthinkvla_from_pi05.sh --gpu 1         # GPU 1
#   bash run_eval_deepthinkvla_from_pi05.sh --no-aggregate  # skip aggregation
set -euo pipefail
...
echo "========================================"
echo "  DeepThinkVLA Replay Attack Evaluation"
echo "  Victim:  ${VICTIM}"
...
echo ""
echo "========================================"
echo "  DeepThinkVLA evaluation complete."
