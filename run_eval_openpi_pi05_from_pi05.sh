#!/usr/bin/env bash
# Evaluate OpenPI π0.5 (openpi_p0.5) on LIBERO using pre-recorded attack prompts from openpi_pi05.
#
...
# openpi_pi05 twice per episode (baseline + attack).
#
# Output goes to outputs/eval_result/ in the same JSON format as the recorded replay.
#
# Usage:
#   bash run_eval_openpi_pi05_from_pi05.sh                 # GPU 0
#   bash run_eval_openpi_pi05_from_pi05.sh --gpu 2          # GPU 2
#   bash run_eval_openpi_pi05_from_pi05.sh --no-aggregate   # skip aggregation
set -euo pipefail
...
echo "========================================"
echo "  OpenPI π0.5 (openpi_p0.5) Replay Attack Evaluation"
echo "  Victim:  ${VICTIM}"
...
echo ""
echo "========================================"
echo "  OpenPI π0.5 evaluation complete."
