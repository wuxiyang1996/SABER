#!/usr/bin/env bash
# Evaluate InternVLA-M1 on LIBERO using pre-recorded attack prompts from openpi_pi05.
#
...
# InternVLA-M1 twice per episode (baseline + attack).
#
...
#
# Usage:
#   bash run_eval_internvla_m1_from_pi05.sh                 # GPU 0
#   bash run_eval_internvla_m1_from_pi05.sh --gpu 2         # GPU 2
#   bash run_eval_internvla_m1_from_pi05.sh --no-aggregate  # skip aggregation
set -euo pipefail
...
echo "========================================"
echo "  InternVLA-M1 Replay Attack Evaluation"
echo "  Victim:  ${VICTIM}"
...
echo ""
echo "========================================"
echo "  InternVLA-M1 evaluation complete."
