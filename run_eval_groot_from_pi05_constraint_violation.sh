#!/usr/bin/env bash
# Evaluate GR00T N1.5-3B (Tacoin fine-tuned) on LIBERO — constraint violation attack records from openpi_pi05.
#
...
echo "========================================"
echo "  GR00T N1.5 Constraint Violation Replay Eval"
echo "  Victim:  ${VICTIM}"
