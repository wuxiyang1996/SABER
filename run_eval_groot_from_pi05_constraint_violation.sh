#!/usr/bin/env bash
# Evaluate GR00T N1.6-3B on LIBERO using pre-recorded constraint-violation attack prompts from openpi_pi05.
#
...
# truth, and runs GR00T twice per episode (baseline + attack).
#
...
#
# Usage:
#   bash run_eval_groot_from_pi05_constraint_violation.sh                 # GPU 3
#   bash run_eval_groot_from_pi05_constraint_violation.sh --gpu 1         # GPU 1
#   bash run_eval_groot_from_pi05_constraint_violation.sh --no-aggregate  # skip aggregation
set -euo pipefail
...
echo "========================================"
echo "  GR00T N1.6 Constraint Violation Replay Attack Evaluation"
echo "  Victim:  ${VICTIM}"
...
echo ""
echo "========================================"
echo "  GR00T constraint violation evaluation complete."
