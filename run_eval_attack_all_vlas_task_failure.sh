#!/usr/bin/env bash
# Run attack evaluation (task_failure) on victim VLA models.
...
#
# Usage:
#   bash run_eval_attack_all_vlas_task_failure.sh                        # run all 8 models
#   bash run_eval_attack_all_vlas_task_failure.sh openvla                # run a single model
#   bash run_eval_attack_all_vlas_task_failure.sh openvla lightvla       # run specific models
set -euo pipefail
...
echo "========================================"
echo "  Cross-Model Attack Evaluation (task_failure)"
