#!/usr/bin/env bash
# Run attack evaluation (action_inflation) on victim VLA models.
...
#
# Usage:
#   bash run_eval_attack_all_vlas_action_inflation.sh                        # run all 8 models
#   bash run_eval_attack_all_vlas_action_inflation.sh openvla                # run a single model
#   bash run_eval_attack_all_vlas_action_inflation.sh openvla lightvla       # run specific models
set -euo pipefail
...
echo "========================================"
echo "  Cross-Model Attack Evaluation (action_inflation)"
