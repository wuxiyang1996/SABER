#!/usr/bin/env bash
# Evaluate OpenPI π0.5 (openpi_p0.5) on LIBERO using pre-recorded constraint-violation attack prompts from openpi_pi05.
#
...
#
# Usage:
#   bash run_eval_openpi_pi05_from_pi05_constraint_violation.sh                 # GPU 0
#   bash run_eval_openpi_pi05_from_pi05_constraint_violation.sh --gpu 2         # GPU 2
#   bash run_eval_openpi_pi05_from_pi05_constraint_violation.sh --no-aggregate  # skip aggregation
set -euo pipefail
...
echo "========================================"
echo "  OpenPI π0.5 Constraint Violation Replay Attack Evaluation"
echo "  Victim:  ${VICTIM}"
...
echo ""
echo "========================================"
echo "  OpenPI π0.5 constraint violation evaluation complete."
