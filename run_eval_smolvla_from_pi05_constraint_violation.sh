#!/usr/bin/env bash
# Evaluate SmolVLA on LIBERO using pre-recorded constraint-violation attack prompts from openpi_pi05.
#
...
# truth, and runs SmolVLA twice per episode (baseline + attack).
#
...
#
# Usage:
#   bash run_eval_smolvla_from_pi05_constraint_violation.sh                 # GPU 3
#   bash run_eval_smolvla_from_pi05_constraint_violation.sh --gpu 1         # GPU 1
#   bash run_eval_smolvla_from_pi05_constraint_violation.sh --no-aggregate  # skip aggregation
set -euo pipefail
...
echo "========================================"
echo "  SmolVLA Constraint Violation Replay Attack Evaluation"
echo "  Victim:  ${VICTIM}"
...
echo ""
echo "========================================"
echo "  SmolVLA constraint violation evaluation complete."
