#!/usr/bin/env bash
# Evaluate X-VLA on LIBERO using pre-recorded attack prompts from openpi_pi05.
#
...
# X-VLA twice per episode (baseline + attack).
#
...
#
# Usage:
#   bash run_eval_xvla_from_pi05.sh                 # GPU 0
#   bash run_eval_xvla_from_pi05.sh --gpu 2         # GPU 2
#   bash run_eval_xvla_from_pi05.sh --no-aggregate  # skip aggregation
set -euo pipefail
